...
SPOT_STYLE = ("#26C6A6", "", "Hébergement")  # fa-bed
...
def render_overview_map_png(days: list) -> bytes | None:
    """Construit une carte unique regroupant tous les points du voyage (randos,
    spots, services), avec des marqueurs identiques (couleur + icône) à ceux de
    la carte interactive. Retourne None si aucune coordonnée n'est disponible,
    ...
    m = StaticMap(900, 550, url_template=OSM_TILE_URL)
    has_marker = False
...
def legend_entries(days: list) -> list:
    ...
    voyage : Randonnée/Hébergement toujours présents, puis les catégories de
